...
<head>
    ...
    <script>
    setTimeout(function(){ window.location = "{{$deepLink}}";}, 15*1000);
    </script>
    ...
    <style>
        *{
        ...
        .transaction{
            ...
            width: 100%;
            text-align: center;
            background-color: hsl(169,100%,30%);
            color: white;
        }
        .button-style{
            display: flex;
    ...
    <div class="container">
        ...
        <div class="table-box">
            ...
            <table class="table table-striped box-shadow" >
                ...
                <tr style="background-color: #a2c5aa4a;">
                ...
                <tr>
                    <td colspan="2">
                        <div class='footer-text'>
                            ...
                            <p style="color: black;font-size: 16px;">4 تا 54 درصد پاداش نقدی به ازای هر خرید</p>
                            @endif
                            <div style="text-align: center;">
                                <div class="container">
                                    ...
                                    <address>
                                        ...
                                        <br>
                                        <abbr > تلفن : </abbr> <span style="direction: ltr;"> ۸۸۸۹۳۵۸۸ (۰۲۱) </span>
                                    </address>
                                </div>
                            </div>
                            <div class="logo-box">
...
<script>
    function color(){
        ...
        // var n3=Math.floor(Math.random()*16);
