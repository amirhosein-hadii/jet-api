...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'body'                  => 'متن',
        'demo'                  => 'متن کوتاه',
        'business_id'           => 'شناسه صنف',
        'amount'                => 'مبلغ',
        'latitude'              => 'موقعیت جغرافیایی',
        'longitude'             => 'موقعیت جغرافیایی',
        ...
        'tel'                   => 'تلفن',
        'loan_id'               => 'شناسه وام',
        'needed_rep_num'        => 'امتیاز مورد نیاز',
        'reputation_num'        => 'امتیاز',
        'requested_credit'      => 'اعتبار درخواستی',
        'card_id'               => 'شناسه کارت',
        'pos_number'            => 'شماره پایانه',
        'license_num'           => 'شماره قرارداد',
        'meters'                => 'متراژ',
        'f_name'                => 'نام خوانوادگی',
        'l_name'                => 'نام',
        'owner_name'            => 'نام صاحب کسب و کار',
        'business_type'         => 'دسته بندی کسب و کار',
        'quality'               => 'امتیاز صنف',
        'region_id'             => 'محله',
        'birthday'              => 'تاریخ تولد',
        'amount_to_convert'     => 'مبلغ تراکنش',
        'where_to_pay'          => 'کسب وکار/ گروه صنفی ',
        'campaign_id'           => 'کمپین ',
        'id'                    => 'شناسه',
        'gift_token'            => 'کد هدیه',
        'pre_token'             => 'پیش کد',
        'ratio_time'             => 'نرخ افزایشی',
        'post_id'             => 'شناسه پست',
        'message'             => 'کامنت',
        'charity_percentage'  => 'درصد خیریه',
        'purchase_experience'  => 'تجربه خرید',
        'work_phone_number' => 'تلفن محل کار',
        'legal_code'        => 'کد معرف',
        'cards' => 'کارت',
        'model_id' => 'مدل وام',
        'national_code' => 'کدملی',
        'cardNumber' => 'شماره کارت',
        'guarantee_mode' => 'نوع ضمانت',
        'guarantee_no' => 'شماره چک صیادی',
